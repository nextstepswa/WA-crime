...
wa_pop_raw <- read_excel("~/GitHub/PopulationEstimates/WA-OFM/ofm_april1_postcensal_estimates_pop_1960-present.xlsx", 
    sheet = "Population", skip = 3) 
...
* The statewide data for 2022 data are not available yet. 
